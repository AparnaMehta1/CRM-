    ...
    return (
        <div>
            ...
            <div className="container main_section text-center">
                ...
                <TicketTable ticketList={ticketList} setTicketList={setTicketList} setTicketUpdateCurr={setTicketUpdateCurr} editTicket={editTicket} listOfTicket={listOfTicket} />

                <div className='my-3'>
                    <UserTable userList={userList} editUserDetails={editUserDetails} userDetails={userDetails} />
                </div>

                {userModal && (
                    <UserModal userModal={userModal} onCloseModal={onCloseModal} cancelUpdate={cancelUpdate} userDetails={userDetails} handleChangeUserData={handleChangeUserData} />
                )}

                {ticketUpdateModal && (
                    <UpdateTicketModal onCloseModal={onCloseModal} ticketUpdateModal={ticketUpdateModal} ticketUpdateCurr={ticketUpdateCurr} cancelUpdate={cancelUpdate} title={"Update Ticket"} handleTicketChange={handleTicketChange} onTicketUpdate={onTicketUpdate} />
                )}
            </div>
        </div>
    )
